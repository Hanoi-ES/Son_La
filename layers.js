...
var format_geo_packageson_la_countour_2 = new ol.format.GeoJSON();
var features_geo_packageson_la_countour_2 = format_geo_packageson_la_countour_2.readFeatures(json_geo_packageson_la_countour_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_geo_packageson_la_countour_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_geo_packageson_la_countour_2.addFeatures(features_geo_packageson_la_countour_2);
var lyr_geo_packageson_la_countour_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_geo_packageson_la_countour_2, 
                style: style_geo_packageson_la_countour_2,
                popuplayertitle: "geo_package — son_la_countour",
                interactive: true,
                title: '<img src="styles/legend/geo_packageson_la_countour_2.png" /> geo_package — son_la_countour'
            });
...
lyr_EsriTopographic_0.setVisible(true);lyr_geo_packagegadm41_vnm_1_1.setVisible(true);lyr_geo_packageson_la_countour_2.setVisible(true);lyr_geo_packageaverage_rainfall_dryseason_3.setVisible(true);
var layersList = [lyr_EsriTopographic_0,lyr_geo_packagegadm41_vnm_1_1,lyr_geo_packageson_la_countour_2,lyr_geo_packageaverage_rainfall_dryseason_3];
...
lyr_geo_packageson_la_countour_2.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'ELEV', });
...
lyr_geo_packageson_la_countour_2.set('fieldImages', {'fid': '', 'ID': '', 'ELEV': '', });
...
lyr_geo_packageson_la_countour_2.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'ELEV': 'inline label - always visible', });
